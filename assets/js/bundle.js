...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/Andrew/projects/frontend-challenge/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/Andrew/projects/frontend-challenge/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var App = React.createClass({
	    ...
	    getPalettes: function getPalettes() {
	        $.getJSON("http://www.colourlovers.com/api/palettes/new?jsonCallback=?", (function (allColours) {
	            if (this.isMounted()) {
	    ...
	    render: function render() {
	        ...
	        if (this.state.palettes.length > 0) {
	            this.state.palettes.map(function (each) {
	                ...
	                renderPalettes.push(React.createElement('div', { className: 'col-sm-6 col-xs-12 row paletteBox', key: each.id }, React.createElement('div', { className: 'col-sm-7 col-xs-7' }, React.createElement('div', { className: 'title row' }, each.title), React.createElement('div', { className: 'by-who row' }, 'by ', each.userName, ' at ', time), React.createElement('div', { className: 'popular row' }, React.createElement('p', { className: 'popularText' }, each.numViews, ' ', each.numViews == 1 ? 'view' : 'views', ' ', each.numVotes, ' ', each.numVotes == 1 ? 'vote' : 'votes'))), React.createElement('img', { src: each.imageUrl, alt: '', className: 'pImage col-sm-5 col-xs-5 float-right' })));
	            });
	        }
	        return React.createElement('div', { className: 'container' }, React.createElement('div', { className: 'colour-title lFont row' }, 'ColourLovers. ', React.createElement('span', { className: 'hFont' }, 'Live.')), React.createElement('div', { className: 'lastUpdated row' }, 'Last updated at ', this.state.updated), React.createElement('div', { className: 'row' }, renderPalettes));
	    }
	});

	React.render(React.createElement(App, null), document.body);

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Andrew/projects/frontend-challenge/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
